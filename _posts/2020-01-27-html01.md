...
![웹 브라우저에서 HTML 문서 확인](https://github.com/notjustmoney/notjustmoney.github.io/blob/master/_posts/img/html01/WebBrowers.PNG)

## HTML 페이지의 구조
아래 그림은 HTML 페이지의 구조를 시각화한 것입니다.

![HTML 구조 시각화](https://github.com/notjustmoney/notjustmoney.github.io/blob/master/_posts/img/html01/VisualizationHTML.PNG)
